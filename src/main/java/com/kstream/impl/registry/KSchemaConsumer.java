...
public class KSchemaConsumer {
	...
	public static void main(String[] args) {
		...
		String topic = "customerPolicy6";
		Collection<String> topics = new ArrayList<>();
		 topics.add("customerPolicy6");
		...
		String jsonSchema = "{\"namespace\":\"com.test\",\"name\":\"customerView2\",\"type\":\"record\",\"fields\":[{\"name\":\"data\",\"type\":\"string\"}]}";
